 ...
 <footer class="footer section">
    <div class="footer__container container grid">
        <div class="footer__content">
            <h3 class="footer_title section_title">Our information</h3>
        ...
        <div class="footer__content">
            <h3 class="footer_title section_title">About Us</h3>
        ...
        <div class="footer__content">
            <h3 class="footer_title section_title">Doroob</h3>
        ...
        <div class="footer__content">
            <h3 class="footer_title section_title">Social</h3>
