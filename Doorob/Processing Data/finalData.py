...
# Filter df2 to only include the desired 'type' values
desired_types = ['zoo', 'shopping_mall', 'park', 'hotel', 'art_gallery']
df2_filtered = df2[df2['type'].isin(desired_types)]

# Prepare a new dataframe with matching columns from df2 to be added into df1
...
# Only add the extra columns if they exist in df1
